...
line_idx,last_saved_page = utils.get_last_saved_page("factcheck")
...
for pagenumber in reversed(range(1,num_pages-last_saved_page)):
	...
	for i in p:
		...
		if page not in dataset.page.unique():
			...
			source_list = [a['href'] for a in sources]
	...
	utils.update_last_saved_page(line_idx,num_pages-pagenumber,"factcheck")