...
line_idx,last_saved_page = utils.get_last_saved_page("snopes")
jumped = 0
...
for pagenumber in reversed(range(1,num_pages-last_saved_page)):
	...
	for article in articlelist:
		...
		source_list = [e['href'] for e in source_elems]
	...
	utils.update_last_saved_page(line_idx,num_pages-pagenumber,"snopes")
